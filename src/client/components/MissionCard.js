    ...
    <div className="white medium p-3 mb-3">
      <div className="card-image grey lighten-3">
        <LazyLoadImage
          ...
          alt={project.rocket.rocket_id}
          src={
            project.links.mission_patch_small
              ? project.links.mission_patch_small
      ...
      <div className="mt-1 mb-1 small">
        ...
        <span className="blue-text">
          {project.launch_success ? `${project.launch_success}` : 'false'}
        </span>
      </div>
      <div className="mt-1 mb-1 small">
        <b>
        ...
        <span className="blue-text">
          {project.rocket.first_stage.cores[0] && project.rocket.first_stage.cores[0].land_success
            ? `${project.rocket.first_stage.cores[0].land_success}`
            : 'false'}
        </span>
      </div>
    </div>
